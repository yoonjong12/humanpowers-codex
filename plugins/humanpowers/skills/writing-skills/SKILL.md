...
**Personal skills live in agent-specific directories (`~/.codex/skills` for Codex)**

You write test cases (pressure scenarios with subagents), watch them fail (baseline behavior), write the skill (documentation), watch tests pass (agents comply), and refactor (close loopholes).

**Core principle:** If you didn't watch an agent fail without the skill, you don't know if the skill teaches the right thing.

**REQUIRED BACKGROUND:** You MUST understand humanpowers:test-driven-development before using this skill. That skill defines the fundamental RED-GREEN-REFACTOR cycle. This skill adapts TDD to documentation.
...
- Good: `**REQUIRED SUB-SKILL:** Use humanpowers:test-driven-development`
- Good: `**REQUIRED BACKGROUND:** You MUST understand humanpowers:systematic-debugging`
...
**REQUIRED BACKGROUND:** The humanpowers:test-driven-development skill explains why this matters. Same principles apply to documentation.
...
### Update Search Optimization for Violation Symptoms
